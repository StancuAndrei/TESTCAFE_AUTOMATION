...
class CheckoutPage{
    constructor() { 
        this.firstNameField = Selector("#BillingNewAddress_FirstName")
        this.lastNameField = Selector("#BillingNewAddress_LastName")
        this.emailField = Selector("#BillingNewAddress_Email")
        ...
        this.nextPaymentBtn = Selector('button').withText('CONTINUE')
        //this.nextConfirmBtn = Selector('input.button-1.payment-info-next-step-button')
        this.nextConfirmBtn = Selector('button').withText('CONTINUE')
        //this.confirmOrderBtn = Selector('input.button-1.confirm-order-next-step-button')
        this.confirmOrderBtn = Selector('button').withText('CONFIRM')
